...
.login_cont{width:100%;min-width:1000px;height:100%;color:#c9c9ca;}
...
.logo_txt{text-align:center;margin:30px 0px 0px -50px;}
...
.login_frm_cont{margin-top:-64px;}
/* .login_frm_logo{width:242px; height:47px; margin:0px auto 40px;} */
.login_frm_logo{margin-bottom: -5px;}
...
/* .login_frm_submit{width:319px; height:32px;line-height:38px; margin:20px auto;cursor:pointer;cursor:hand;background-color:#e60012;font-size:16px;color:#fff} */
