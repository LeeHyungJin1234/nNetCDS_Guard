		...
		<div class="right_col" role="main">
			...
			<div class="contents">
					...
					<div class="box_cont3 x_content" >
						<div class="row">
							<div class="col-md-2 col-sm-12 col-xs-12" style="padding:0px;">
								<div id="cpu"></div>
								<!--<div id="g_cpu" style="width:152px; height:152px; margin:0 auto;">CPU</div>-->
							</div>
							<div class="col-md-2 col-sm-12 col-xs-12" style="padding:0px;">
								<div id="ram"></div>
								<!--  <div id="g_ram" style="width:152px; height:152px; margin:0 auto;">RAM</div>-->
							</div>
							<div class="col-md-2 col-sm-12 col-xs-12" style="padding:0px;">
								<div id="hdd"></div>
								<!--<div id="g_hdd" style="width:152px; height:152px; margin:0 auto;">HDD</div>-->
							</div>
							<!-- <div class="col-md-6 col-sm-12 col-xs-12">
								<div style="background-color:#4b5f71;border-radius:20px;width:282px;border:2px solid #000;padding:10px 20px 10px 20px;margin:40px auto"><img src="/images/logo_v.png" alt="nNetDiode V2.0" /></div>
							</div>-->
						</div>
						<div class="row">
				...
				<div class="col-md-4 col-sm-12 col-xs-12 form-horizontal" style="padding-left:0px;">
					<div class="box_cont4 x_content" style="height:326px;">
						<div class="form-group under_line" style="padding:5px;">
							<label class="control-label col-md-4 col-sm-12 col-xs-12" style="padding:5px;">장비이름 :</label>
							<div class="checkbox col-md-8 col-sm-12 col-xs-12" style="padding:5px;"><label><c:if test="${getNcProduct.np_name == '' || getNcProduct.np_name eq null}">─</c:if>${getNcProduct.np_name}</label></div>
						</div>
						<div class="form-group under_line" style="padding:0px;">
							<label class="control-label col-md-4 col-sm-12 col-xs-12" style="padding:5px;">모델 :</label>
							<div class="checkbox col-md-8 col-sm-12 col-xs-12" style="padding:5px;"><label><c:if test="${getNcProduct.np_model == '' || getNcProduct.np_model eq null}">─</c:if>${getNcProduct.np_model}</label></div>
						</div>
						<div class="form-group under_line" style="padding:0px;">
							<label class="control-label col-md-4 col-sm-12 col-xs-12" style="padding:5px;">시리얼 넘버 :</label>
							<div class="checkbox col-md-8 col-sm-12 col-xs-12" style="padding:5px;"><label><c:if test="${getNcProduct.np_sn == '' || getNcProduct.np_sn eq null}">─</c:if>${getNcProduct.np_sn}</label></div>
						</div>
						<div class="form-group under_line" style="padding:0px;">
							<label class="control-label col-md-4 col-sm-12 col-xs-12" style="padding:5px;">OS :</label>
							<div class="checkbox col-md-8 col-sm-12 col-xs-12" style="padding:5px;"><label><c:if test="${getNcProduct.np_os == '' || getNcProduct.np_os eq null}">─</c:if>${getNcProduct.np_os}</label></div>
						</div>
						<div class="form-group under_line" style="padding:0px;">
							<label class="control-label col-md-4 col-sm-12 col-xs-12" style="padding:5px;">기술지원 :</label>
							<div class="checkbox col-md-8 col-sm-12 col-xs-12" style="padding:5px;"><label><c:if test="${getNcProduct.np_tel == '' || getNcProduct.np_tel eq null}">─</c:if>${getNcProduct.np_tel}</label></div>
						</div>
						<div class="form-group under_line" style="padding:0px;">
							<label class="control-label col-md-4 col-sm-12 col-xs-12" style="padding:5px;">설치날짜 :</label>
							<div class="checkbox col-md-8 col-sm-12 col-xs-12" style="padding:5px;"><label><c:if test="${getNcProduct.np_date == '' || getNcProduct.np_date eq null}">─</c:if>${getNcProduct.np_date}</label></div>
						</div>
						<div class="form-group under_line" style="padding:0px;">
							<label class="control-label col-md-4 col-sm-12 col-xs-12" style="padding:5px;">설명 :</label>
							<div class="checkbox col-md-8 col-sm-12 col-xs-12" style="padding:5px;height:90px;overflow:auto"><label><c:if test="${getNcProduct.np_desc == '' || getNcProduct.np_desc eq null}">─</c:if>${getNcProduct.np_desc}</label></div>
						</div>
					</div>
				</div>
...
/*
	...
	function drawChart() {
		...
		var chart_cpu = new google.visualization.Gauge(document.getElementById('g_cpu'));
		var chart_ram = new google.visualization.Gauge(document.getElementById('g_ram'));
		var chart_hdd = new google.visualization.Gauge(document.getElementById('g_hdd'));

		var temp = getSystem_monitor();
		var sys_value = temp.split("|");
		
		data_cpu.setValue(0, 1, sys_value[0]);
		data_ram.setValue(0, 1, sys_value[1]);
		data_hdd.setValue(0, 1, sys_value[2]);

		chart_cpu.draw(data_cpu, options);
		chart_ram.draw(data_ram, options);
		chart_hdd.draw(data_hdd, options);
