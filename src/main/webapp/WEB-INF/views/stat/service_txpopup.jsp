...
<div class="main-pop">
	...
	<div class="content">
		...
		<div class="graph">
			<div class="graph1">
				<span>내부망 데이터 수집</span>
				<div id="recv" class="chart"></div>
			</div>
			<div class="graph2">
     			<span>일방향 데이터 송신</span>
     			<div id="send" class="chart"></div>
			</div>
			<div class="graph3" style="margin-top:12px;">
				<span>재전송 데이터</span>
				<div id="repebt" class="chart"></div>
			</div>
			<div class="graph4" style="margin-top:12px;">
				<span>손실 데이터</span>
				<div id="repeyn" class="chart"></div>
			</div>
		</div>
	</div>
</div>
	...
	function getTraffic_ct(){
		$.ajax({
			...
			success: function(data) {
				...
				createLineChart("repebt", data.repeBtCtData);
				createLineChart("repeyn", data.repeYnCtData);
			},
