		...
		if (confirm("<spring:message code='program.wantcheck'/>")) {
			$.ajax({
				...
				success : function(data) {
					if (data == "success") {
						alert("<spring:message code='program.checkexec'/>");
						location.replace('/rvs_self_protect.do');
					}else if (data == "fail") {
		...
		<div id="right-content">
			<div class="right-wrapper">
				...
				<div class="btn-section clearfix">
					...
					<input type="hidden" name="nci_div" value="4"/>
					...
					<a href="javascript:update_cycle();" id="white-top-btn" style="margin-right:8px;"><img src="/img/modify.png" style="margin:3px 8px 0 0;">수정하기</a>
					<span style="float:right; padding-right:20px;">
						<a href="javascript:inspect();" id="red-top-btn" class="forward_btn" style="margin-right:8px;"><img src="/img/btncheck.png" style="margin:6px 8px 0 0;"><spring:message code='program.integcheck'/></a>
						<a href="javascript:update_hash();" id="white-top-btn" class="forward_btn"><img src="/img/update.png" style="margin:4px 8px 0 0;"><spring:message code='program.integupdate'/></a>
					</span>
				</div>
					...
					<colgroup>
						...
						<c:forEach var="receive" items="${receiveList}" varStatus="status">
							<tr class="text-medium text-main-color">
								...
								<td align="center"><span>${receive.ncp_name}</span></td>
								<td align="center"><span>${receive.ncp_file_name}</span></td>
								<td align="center"><span>${receive.ncp_hash}</span></td>
								<td align="center"><span><fmt:formatNumber value="${receive.ncp_file_size}" pattern="###,###" /></span></td>
								<td align="center">${receive.ncp_hash_date}</td>
							</tr>
						</c:forEach>
						</tbody>
						<tfoot>
