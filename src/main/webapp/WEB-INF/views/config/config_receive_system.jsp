		...
		if( check ){
			...
			$.ajax({        
				...
				success: function(data) {
					if(data == "true"){
						alert("등록되었습니다.");
						location.replace('/receive_network.do');
					}else{
						alert(data);
					}
				},
		...
		<div id="exampleWrap">
	    	...
	    	<div class="bbsList" style="margin-top:30px;width:95%">
				<table style="padding-top:30px;" class="boardList" >
					...
					<thead>	
					<tr>
						<th>내부IP</th><th><sf:input path="ncs_int_ip" size="50" maxlength="50" /></th>
						<th>외부IP</th><th><sf:input path="ncs_ext_ip" size="50" maxlength="50" /></th>
						<th>DNS</th><th><sf:input path="ncs_dns" size="50" maxlength="50" /></th>
