			...
			if (confirm("등록하시겠습니까?") == true) {
				...
				$.ajax({        
					...
					success: function(data) {
						if(data == "true"){
							alert("등록되었습니다.");
							location.replace('/config_rcv_link.do');
						}else{
							alert(data);
						}
					},
		...
		<div class="right_col" role="main">
			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						<div class="x_title">
							<h2>네트워크 설정 <small style="color:red;font-weight:bold">* 연계 시스템 네트워크 설정이 내/외부 모두 등록되어야 정상 동작 됩니다.</small></h2>
							<div class="clearfix"></div>
						</div>
				    	...
				    	<c:choose>
							<c:when test="${ !empty receiveList }">
								...
								<sf:hidden path="nclk_seq" value="${receive.nclk_seq}" />
								<sf:hidden path="nclk_div" value="2" /> <!-- 송수신 구분 -->
								...
								<div class="item form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<sf:input path="nclk_rcv_ip" class="form-control col-md-7 col-xs-12" value="${receive.nclk_rcv_ip}" maxlength="15" />
									</div>
								</div>
								<div class="item form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12">Netmask</label>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<sf:input path="nclk_rcv_nm" class="form-control col-md-7 col-xs-12" value="${receive.nclk_rcv_nm}" maxlength="15" />
									</div>
								</div>
								<div class="item form-group">
								...
								<div class="item form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12">IP</label>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<sf:input path="nclk_snd_ip" class="form-control col-md-7 col-xs-12" value="${receive.nclk_snd_ip}" maxlength="15" />
									</div>
								</div>
								<div class="item form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12">Netmask</label>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<sf:input path="nclk_snd_nm" class="form-control col-md-7 col-xs-12" value="${receive.nclk_snd_nm}" maxlength="15" />
									</div>
								</div>
								<div class="item form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12">Gateway</label>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<sf:input path="nclk_snd_gw" class="form-control col-md-7 col-xs-12" value="${receive.nclk_snd_gw}" maxlength="15" />
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-md-6 col-md-offset-3">
										<button type="button" class="btn btn-primary" onClick="javascript:location.replace('/config_rcv_link.do');">취소</button>
