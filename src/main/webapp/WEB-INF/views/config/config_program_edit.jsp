									...
									<div class="item form-group">
										...
										<div class="col-md-9 col-sm-9 col-xs-12">
											<sf:select path="ncp_div" class="form-control col-md-7 col-xs-12">
												<option value="1" <c:if test="${programToRegit.ncp_div == 1}">selected</c:if>><spring:message code='config.inside'/></option>
												<option value="2" <c:if test="${programToRegit.ncp_div == 2}">selected</c:if>><spring:message code='config.outside'/></option>
											</sf:select>
										</div>
									</div>
