...
<script type="text/javascript">
	function log_search() {   
		...
		form.action="integrity_grid_search.do";
		form.submit();
	}
...
<script>
	...
	const dataGrid = $('#gridContainer').dxDataGrid({
	    ...
	    columns: [{
		  ...
		  dataField: 'nli_risk_level',
		  caption: '위험도',
		  alignment: 'center',
		  dataType: 'String',
		  width: 127,
		  cellTemplate(container, options) {
	          container.parent().addClass((options.data.nli_risk_level == '위험') ? 'inc' : 'dec');
	          container.html(options.text);
	        }
		 },{
	      dataField: 'nli_prog_name',
	      caption: '작업 구분',
	      alignment: 'center',
	      dataType: 'String',
	      width: 242,
	    }, {
		  dataField: 'nli_message',
		  caption: '세부내용',
		  alignment: 'center',
		  dataType: 'String',
		  width: 500,
