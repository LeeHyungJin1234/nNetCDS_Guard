	...
	<div>
		...
		<c:choose>
			<c:when test="${pginfo.currentPage > 1}">
				<a href="javascript:${scriptName}(${1});" style="margin-right:-4px;border-left-width:1px;" class="page-box"><img src="/img/trans.png" style="background:url(/img/page-arrow1.png) no-repeat; width:10px;height:10px; vertical-align: middle;"></a>
				<a href="javascript:${scriptName}(${pginfo.currentPage -1});" class="page-box" style="border-left-width:0;"><img src="/img/trans.png" style="background:url(/img/page-arrow2.png) no-repeat 1px top; width:10px;height:10px; vertical-align: middle;"></a>
			</c:when>
			<c:otherwise>
		...
		<c:forEach items="${pginfo.pagesArray}" var='pgno' >
			<c:choose>
				...
				<c:otherwise>
					<li><a href="javascript:${scriptName}(${pgno});">${pgno}</a></li>
				</c:otherwise>
			</c:choose>
		</c:forEach>
		</ul>
		...
		<c:choose>
			<c:when test="${pginfo.currentPage < pginfo.totalPage}">
				<a href="javascript:${scriptName}(${pginfo.currentPage + 1});" style="margin-right:-4px;border-left-width:1px;" class="page-box"><img src="/img/trans.png" style="background:url(/img/page-arrow3.png) no-repeat 3px top; width:10px;height:10px; vertical-align: middle;"></a>
				<a href="javascript:${scriptName}(${pginfo.totalPage});" class="page-box" style="border-left-width:0;"><img src="/img/trans.png" style="background:url(/img/page-arrow4.png) no-repeat; width:10px;height:10px; vertical-align: middle;"></a>
			</c:when>
			<c:otherwise>
