...
function clickTrEvent(trObj) {
	$(trObj).closest("tr").toggleClass('hideGraphfont');
	$(trObj).find("div").toggle();
}
</script>
<style>
.hideGraphfont {
				...
				<form id="search" method="post" class="form-horizontal form-label-left">
					<div class="form-group">
						<div class="col-md-8 col-sm-12 col-xs-12 form-inline form-group">
							<label style="margin-right:10px;"><spring:message code='stat.searchperiod'/></label>
							...
							<button type="button" class="btn btn-primary" onClick="javascript:search();" style="margin-left:20px"><i class="fa fa-search"></i> <spring:message code='btn.search'/></button>
							<button type="button" class="btn btn-success" onClick="location.href='/stat_traffic.do'"><i class="fa fa-refresh"></i> <spring:message code='btn.reset'/></button>
						</div>
						<label class="control-label col-md-4 col-sm-12 col-xs-12 form-group" style="color:red;font-weight:bold;text-align:left">* <spring:message code='stat.searchdesc'/></label>
					</div>
				</form>
			</div>
								...
								<div class="box_cont x_content">
									<div class="m_content">
										...
										<table class='data_table'>
											<tr>
												<td class="tdTitle"><spring:message code='stat.service'/></td>
												<td class="tdNumber"><spring:message code='stat.collection'/></td>
												<td class="tdBlank">&nbsp;</td>
											</tr>
										</table>
										<div id='collect_table' class="serviceList"></div>
									</div>			                  
								</div>
	                		</div>
							...
							$.ajax({
								...
								success: function(data1) {
								    ...
								    Array.prototype.forEach.call(
								      document.querySelectorAll('.toggle-graph1'),
								      function (tr) {
								        tr.addEventListener('click', function(e) {
								          var graph = chart1.graphs[e.currentTarget.dataset.graphIndex];
								          if (graph.hidden) {
								            chart1.showGraph(graph);
								          } else {
								            chart1.hideGraph(graph);
								          }
								        });
								      }
								    );
								    
					          		chart1 = AmCharts.makeChart("collect_chart", {
					          			"theme": "light",
					          		    "type": "serial",
								...
								<div class="box_cont x_content">
									<div class="m_content">
										...
										<table class='data_table'>
											<tr>
												<td class="tdTitle"><spring:message code='stat.service'/></td>
												<td class="tdNumber"><spring:message code='stat.tranamount'/></td>
												<td class="tdBlank">&nbsp;</td>
											</tr>
										</table>
										<div id='send_table' class="serviceList"></div>
									</div>			                  
								</div>
	                		</div>
	                		<div class="clearfix"></div>
						...
						function drawSend(){
							...
							$.ajax({
								...
								success: function(data1) {
									var chart2;
								    Array.prototype.forEach.call(
								      document.querySelectorAll('.toggle-graph3'),
								      function (tr) {
								        tr.addEventListener('click', function(e) {
								          var graph = chart2.graphs[e.currentTarget.dataset.graphIndex];
								          if (graph.hidden) {
									...
									chart2 = AmCharts.makeChart("send_chart", {
					          			"theme": "light",
					          		    "type": "serial",
					          		    "dataDateFormat": "YYYY-MM-DD JJ:NN",
					          		    "dataProvider": data1.data_value,
								...
								<div class="box_cont x_content">
									<div class="m_content">
										...
										<table class='data_table'>
											<tr>
												<td class="tdTitle"><spring:message code='stat.service'/></td>
												<td class="tdNumber"><spring:message code='stat.lossamount'/></td>
												<td class="tdBlank">&nbsp;</td>
											</tr>
										</table>
										<div id='loss_table' class="serviceList"></div>				                  
									</div>
								</div>
	                		</div>
	                		<div class="col-md-8 col-sm-8 col-xs-12 padding_l5">
							...
							$.ajax({
				       		...
				       		$.ajax({
								...
								success: function(data1) {
									var chart3;
								    Array.prototype.forEach.call(
								      document.querySelectorAll('.toggle-graph2'),
								      function (tr) {
								        tr.addEventListener('click', function(e) {
								          var graph = chart3.graphs[e.currentTarget.dataset.graphIndex];
								          if (graph.hidden) {
								            chart3.showGraph(graph);
								          } else {
								            chart3.hideGraph(graph);
								          }
								        });
								      }
								    );
								    
									chart3 = AmCharts.makeChart("loss_chart", {
					          			"theme": "light",
					          		    "type": "serial",
					          		    "dataDateFormat": "YYYY-MM-DD JJ:NN",
					          		    "dataProvider": data1.data_value,
								...
								<div class="box_cont x_content">
									<div class="m_content">
										...
										<table class='data_table'>
											<tr>
												<td class="tdTitle"><spring:message code='stat.service'/></td>
												<td class="tdNumber"><spring:message code='stat.retransmission'/></td>
												<td class="tdBlank">&nbsp;</td>
											</tr>
										</table>
										<div id='repeat_table' class="serviceList"></div>
									</div>			                  
								</div>
	                		</div>
	                		<div class="clearfix"></div>
							...
							$.ajax({
				       		...
				       		$.ajax({
								...
								success: function(data1) {
									var chart4;
								    Array.prototype.forEach.call(
								      document.querySelectorAll('.toggle-graph4'),
								      function (tr) {
								        tr.addEventListener('click', function(e) {
								          var graph = chart4.graphs[e.currentTarget.dataset.graphIndex];
								          if (graph.hidden) {
								            chart4.showGraph(graph);
								          } else {
								            chart4.hideGraph(graph);
								          }
								        });
								      }
								    );
								    
									chart4 = AmCharts.makeChart("repeat_chart", {
					          			"theme": "light",
					          		    "type": "serial",
					          		    "dataDateFormat": "YYYY-MM-DD JJ:NN",
					          		    "dataProvider": data1.data_value,
