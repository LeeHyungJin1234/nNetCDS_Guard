...
<script type="text/javascript">
	function log_search() {   
		...
		form.action="event_grid_search.do";
		form.submit();
	}
...
<script>
	...
	const dataGrid = $('#gridContainer').dxDataGrid({
	    ...
	    columns: [{
		  ...
		  dataField: 'nle_risk_level',
		  caption: '위험도',
		  alignment: 'center',
		  dataType: 'String',
		  width: 126,
		  cellTemplate(container, options) {
	          container.parent().addClass((options.data.nle_risk_level == '위험') ? 'inc' : 'dec');
	          container.html(options.text);
	        }
		 }, {
		  dataField: 'nle_message',
		  caption: '세부 내용',
		  alignment: 'center',
		  dataType: 'String',
		  width: 546,
